...
public class DataBaseHelper extends SQLiteOpenHelper {
	...
	private static String DB_PATH = "/data/data/com.clusterdev.ragam/databases/";

	private static String DB_NAME = "ragam.db";
	...
	public Cursor getEvents(String type) {
		...
		return myDataBase.rawQuery("SELECT rowid _id,name,description,code,time FROM events WHERE type=? ORDER BY time COLLATE NOCASE",a);
